...
typedef struct {	/* bhed - binary header */
	...
	int   line1;    /* the first lines No. .*/
	int   line2;    /* the last lines No. .*/
	int   dline;    /* step of lines No. .*/
	int   lineno;   /* lines No. .*/
	int   ncdp;	/* total number of CDPs. */
	int   cdp1;     /* the first CDP No. .*/
	int   cdp2;     /* the last CDP No. .*/
	int   dcdp;     /* step of CDP No. .*/
	int   nvel;	/* total number of vels. */
	float vel1;     /* the first vel .*/
	float vel2;     /* the last vel .*/
	float dvel;     /* step of vel.*/
	short hunass[144];	/* unassigned */
